 ...
 */
//
//  MFUpdateVMWithDataLoaderAction.h
//  MFCore
//
//
 ...
 * @discussion
 */
@interface MFUpdateVMWithDataLoaderAction : NSObject<MFActionProtocol>

FOUNDATION_EXPORT NSString *const MFAction_MFUpdateVMWithDataLoaderAction ;
