...
/*!
 * @class MFEmailFieldValidator
 * @brief The FieldValidator for email
 * @discussion This validator checks the valid email value
 */
@interface MFEmailFieldValidator : NSObject <MFFieldValidatorProtocol>
