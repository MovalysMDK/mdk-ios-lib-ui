...
@implementation MFIntegerFieldValidator

+(instancetype)sharedInstance{
    static MFIntegerFieldValidator *instance = nil;
...
-(MFError *)validate:(id)value withCurrentState:(NSDictionary *)currentState withParameters:(NSDictionary *)parameters {
    ...
    if([value isKindOfClass:[NSString class]]) {
        if(![self matchPattern:value withParameters:parameters]) {
            result = [[MFInvalidIntegerValueUIValidationError alloc]  initWithLocalizedFieldName:parameters[@"componentName"] technicalFieldName:parameters[@"componentName"]];
        }
    }
    return result;
}
