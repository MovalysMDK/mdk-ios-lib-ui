...
@interface MFMenuViewController : UIViewController<MFViewControllerProtocol, MFMenuViewControllerProtocol>

@property(nonatomic, strong) UIImageView *sopraImageView;

@property(nonatomic, strong) NSMutableArray *menuButtons ;

@property(nonatomic) BOOL firstLaunching ;
