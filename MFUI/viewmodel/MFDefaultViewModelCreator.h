...
@interface MFDefaultViewModelCreator : NSObject

-(id) createVM:(NSString*) p_vmClassName ;

-(id) createVM:(NSString *)vmClassName withData:(NSFetchedResultsController *)data
            andItemVmClass:(NSString *)itemVmClass;
